package com.ek.project.system.user.controller;


import com.ek.common.utils.ShiroUtils;
import com.ek.common.utils.StringUtils;
import com.ek.common.utils.file.FileUploadUtils;
...
public class ProfileController extends BaseController {
    ...
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file, Long userId) {
        ...
        try {
            if (!file.isEmpty()) {
                String avatar = FileUploadUtils.upload(EKConfig.getAvatarPath(), file);
